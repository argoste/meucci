...
<html lang="en">
  ...
  <body>
    ...
    progettazione Biblioteca Fittizia Meucci. Ho progettato database subito
    dopo aver studiato un po' di teoria delle basi di dati (forme normali di
    Codd, ecc). Il progetto é esposto <a href="meucci/progettazione_db.php">
    qui</a>. Con le dovute modifiche puó essere la base per Pergamos.</p>
